...
$document->addStyleSheet('https://fonts.googleapis.com/css?family=Oswald:400,300');
$document->addStyleSheet('https://fonts.googleapis.com/css?family=Dosis:400,300,600,700');
$document->addStyleSheet('https://fonts.googleapis.com/css?family=Playfair+Display:400,700,900');
...
<ul class="switcher">
        ...
        <ul class="demo-list-fonts">
        	<li>
                ...
                <select data-assign="body">
                    ...
                    <option value="f5">Playfair Display</option> 
                </select>    
            </li>
            <li>
                <p>Menu Font</p>
    ...
    <li class="switcher-box">
        <a href="http://themeforest.net/user/phpkungfu/portfolio" class="btn btn-primary btn-block" target="_blank">Purchase HUge Shop now</a>
    </li>
</ul>