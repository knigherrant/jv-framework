			...
			<div class="col-sm-<?php echo 12/$max_cols?> col-md-<?php echo 12/$max_cols?>">
                <div class="item">
                    ...
                    <a class="image" href="" data-bind="attr: {href: $parent.product_link}, css: JVAjaxShopSearchModel<?php echo $module->id?>.image_align()">
                        <img <?php echo $image_width;?> <?php echo $image_height;?> data-bind="attr: {src: $parent.image_url, alt: $parent.product_name, title: $parent.product_name}"  onError="this.src='<?php echo JUri::base().'/components/com_virtuemart/assets/images/vmgeneral/'.VmConfig::get('no_image_set'); ?>';">
                    </a>
                    <!-- /ko -->
