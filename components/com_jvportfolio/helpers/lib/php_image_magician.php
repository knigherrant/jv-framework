...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/   
  ...
  public function addCaptionBox($side='b', $thickness=50, $padding=0, $bgColor='#000', $transaprencyAmount=30, $x2=null)
  #
  # Author:   Jarrod Oberto
  # Date:   26 May 2011
  ...
  #     
  {
      ...
      imagefilledrectangle($this->imageResized, $positionArray['x1'], $positionArray['y1'], $x2, $positionArray['y2'], $transparent);
  }
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/   
  ...
  private function getTextFont($font)
  {
    ...
    if ($font == null || !file_exists($font)) {
      ...
      $font = $fontPath . '/OpenSans-Light.ttf';
