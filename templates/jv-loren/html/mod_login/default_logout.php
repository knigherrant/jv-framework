...
<?php if ($params->get('greeting')) : ?>
	<?php
		...
		if (preg_match("|200|", $grav_url[0])) {
			$grav_url = JUri::base().'templates/jv-loren/images/avatar/default.jpg';
		}
	?>				
...
<?php endif; ?>
	<div class="logout-button">
		<input type="submit" name="Submit" class="btn btn-darker btn-xs" value="<?php echo JText::_('JLOGOUT'); ?>" />
