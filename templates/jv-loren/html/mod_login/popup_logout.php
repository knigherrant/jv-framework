...
<div class="logout-form dropdown inline-block">
  <button type="button" class="btn btn-logout dropdown-toggle btn-default" data-toggle="dropdown">
  	<i class="fa fa-user ico-mobile"></i>
  	<span class="name">
  ...
  <div class="dropdown-menu dropdown-menu-right" role="menu">
  	...
  	<ul class="menu list-unstyled mb-5">
		<li>
			<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" class="login-form form-vertical pl-20 pr-20">
	        <button type="submit" class="btn btn-default btn-xs"><?php echo JText::_('JLOGOUT'); ?> </button>
