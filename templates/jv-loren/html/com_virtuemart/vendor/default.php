...
$vendorPerRow = 3;
if ($vendorPerRow != 1) {
	$vendorCellWidth = ' col-sm-'.floor ( 12 / $vendorPerRow );
} else {
	$vendorCellWidth = '';
}
...
<div class="vendor-view-default">
	...
	foreach ( $this->vendors as $vendor ) {
        ...
        <div class="manufacturer <?php echo $vendorCellWidth . $showVerticalSeparator ?>">
            <div class="panel panel-default vendor-description">
                <div class="panel-heading">
                    <h3 class="panel-title"><a title="<?php echo $vendor->vendor_store_name; ?>" href="<?php echo $vendorsLink; ?>"><?php echo $vendor->vendor_store_name; ?></a></h3>
                </div>
                <div class="panel-body">
                    <a title="<?php echo $vendor->vendor_store_name; ?>" href="<?php echo $vendorsLink; ?>"><?php echo $vendor->vendor_name; ?></a>
