...
<div class="vendor-details-view">
    ...
    <div class="form-field mt-30">
		...
		<form method="post" class="form-validate" action="<?php echo JRoute::_('index.php') ; ?>" name="askform" id="askform">
			...
			<br>
			<p class="submit">
				<input class="btn btn-primary btn-sm" type="submit" name="submit_ask" title="<?php echo vmText::_('COM_VIRTUEMART_ASK_SUBMIT')  ?>" value="<?php echo vmText::_('COM_VIRTUEMART_ASK_SUBMIT')  ?>" />
			</p>
