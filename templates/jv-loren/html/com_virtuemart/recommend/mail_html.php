...
<div width="100%">
	<table style="margin: auto; width: 600px; border: solid #dad8d8 1px" cellpadding="0" cellspacing="0"  ><tr><td>
		<tr>
			<td valign="top" style="text-align: center;" style="padding: 15px 25px;">
				...
				<table  border="0" cellpadding="0" cellspacing="0" class="html-email" width="100%">
					...
					<tr>
						<td style="text-align: center;" style="border-bottom : 1px solid #dad8d8;">
					...
					<tr>
						<td style="text-align: center;" style="border-bottom : 1px solid #dad8d8; padding: 15px;">
