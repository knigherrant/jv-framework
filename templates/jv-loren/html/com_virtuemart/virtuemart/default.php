...
<div class="vendor-store-desc text-center pb-30">
	<div class="vendor-store-desc-body">
		...
		<div class="vendor-store-desc-content">
...
if ($this->categories and VmConfig::get('show_categories', 1)) echo '<div class="pb-60">'.$this->renderVmSubLayout('categories',array('categories'=>$this->categories,'categories_per_row' => $homepage_categories_per_row)).'</div>';
