...
<div class="billto-shipto">
	<div class="row">
		<div class="col-sm-6">
			<div class="featured-box featured-box-secondary featured-box-cart ">
				<div class="box-content">
					<h5 class="text-uppercase mt-0"><?php echo vmText::_ ('COM_VIRTUEMART_USER_FORM_BILLTO_LBL'); ?></h5>
					...
					?>
					<a class="btn btn-default btn-sm btn-outline <?php echo $this->pointAddress ?>" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=BT', $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
		...
		<div class="col-sm-6">
			<div class="featured-box featured-box-secondary featured-box-cart ">
				<div class="box-content">
					<h5 class="text-uppercase mt-0"><?php echo vmText::_ ('COM_VIRTUEMART_USER_FORM_SHIPTO_LBL'); ?></h5>
					<?php // Output Bill To Address ?>
					...
					<a class="btn btn-default btn-sm btn-outline" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=ST&virtuemart_user_id[]=' . $this->cart->lists['current_id'], $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
