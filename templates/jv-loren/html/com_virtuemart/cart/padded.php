...
<?php
	...
	$this->continue_link = '<a class="continue_link btn btn-default btn-sm pull-left" href="' .JRoute::_ ('index.php?option=com_virtuemart&view=category' . $categoryStr.$ItemidStr, FALSE) . '">' . vmText::_ ('COM_VIRTUEMART_CONTINUE_SHOPPING') . '</a>'; 
?>
<div class="popup-added">
	...
	echo '<a class="showcart btn btn-primary btn-sm pull-right" href="' . JRoute::_('index.php?option=com_virtuemart&view=cart') . '"><i class="gala-shopping82"></i>&nbsp;' . vmText::_('COM_VIRTUEMART_CART_SHOW') . '</a>';
