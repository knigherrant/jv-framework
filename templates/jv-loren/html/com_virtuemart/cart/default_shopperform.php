...
<div class="featured-box">
	...
	<form action="<?php echo JRoute::_ ('index.php'); ?>" method="post" class="form-inline">
		...
		<input type="submit" class="btn btn-default btn-outline mr-20" name="searchShopper" title="<?php echo vmText::_('COM_VIRTUEMART_SEARCH'); ?>" value="<?php echo vmText::_('COM_VIRTUEMART_SEARCH'); ?>" />
		<?php 
		...
		?>
		<input type="submit" name="changeShopper" title="<?php echo vmText::_('COM_VIRTUEMART_SAVE'); ?>" value="<?php echo vmText::_('COM_VIRTUEMART_SAVE'); ?>" class="btn btn-default btn-outline"/>
