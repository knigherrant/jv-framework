		...
		<div class="col-xs-8">
			...
			if(!empty($this->manufacturer->mf_email)) { ?>
				<div class="manufacturer-email">
					<span class="manufacturer-label"><?php echo vmText::_('COM_VIRTUEMART_EMAIL') ?>: </span>
					<span>
			...
			if(!empty($this->manufacturer->mf_url)) { ?>
				<div class="manufacturer-url">
					<span class="manufacturer-label"><?php echo vmText::_('COM_VIRTUEMART_MANUFACTURER_PAGE') ?>: </span>
			...
			if(!empty($this->manufacturer->virtuemart_manufacturer_id)) { ?>
					<a target="_top" href="<?php echo $manufacturerProductsURL; ?>" class="btn btn-primary btn-sm"><?php echo vmText::sprintf('COM_VIRTUEMART_PRODUCT_FROM_MF',$this->manufacturer->mf_name); ?></a>
			<?php } ?>
		</div>
	</div>
</div>