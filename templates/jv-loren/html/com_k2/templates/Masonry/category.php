...
$document->addScriptDeclaration('
	(function($){
		$(function(){
			$(".blog-masonry .itemList").imagesLoaded( function() {
				var $grid = $(".blog-masonry .itemList");
				  $grid.shuffle({
...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?> blog-masonry">
	...
	<!-- Item list -->
	<div class="row itemList mb-20">
			<?php if(isset($this->leading) && count($this->leading)): ?>
				<!-- Leading items -->
				<?php foreach($this->leading as $key=>$item): ?>
				<div class="col-xxs-12 col-xs-6 col-md-<?php echo number_format(12/$this->params->get('num_leading_columns'), 0)?> post-mansory-item">
					<?php
			...
			<!-- Primary items -->
					...
					<div class="col-xxs-12 col-xs-6 col-md-<?php echo number_format(12/$this->params->get('num_primary_columns'), 0)?> post-mansory-item">
						<?php
							// Load category_item.php by default
							$this->item=$item;
							echo $this->loadTemplate('item');
			...
			<!-- Secondary items -->
					...
					<div class="col-xxs-12 col-xs-6 col-md-<?php echo number_format(12/$this->params->get('num_secondary_columns'), 0)?> post-mansory-item">
						<?php
							// Load category_item.php by default
							$this->item=$item;
							echo $this->loadTemplate('item');
