	...
	<div id="k2FrontendContainer">
		<div id="k2Frontend">
			<table class="k2FrontendToolbar" cellpadding="2" cellspacing="4">
				<tr>
					<td id="toolbar-save">
						<a class="btn btn-primary" href="#" onclick="Joomla.submitbutton('save'); return false;"> <span title="<?php echo JText::_('K2_SAVE'); ?>" class="icon-32-save icon-save"></span> <?php echo JText::_('K2_SAVE'); ?> </a>
					</td>
					<td id="toolbar-cancel">
						<a class="btn btn-default" href="#"> <span title="<?php echo JText::_('K2_CANCEL'); ?>" class="icon-32-cancel icon-cancel"></span> <?php echo JText::_('K2_CLOSE'); ?> </a>
					</td>
				</tr>
			</table>
			...
			<table cellspacing="0" cellpadding="0" border="0" class="adminFormK2Container table">
				<tbody>
					<tr>
						<td>
							<table class="adminFormK2 table table-bordered">
								<tr>
								...
								<tr>
									...
									<td class="adminK2RightCol radio">
							...
							<div class="simpleTabs" id="k2Tabs">
								...
								<div class="simpleTabsContent" id="k2Tab2">
									<table class="admintable table">
										<tr>
											...
											<td>
												<input type="file" name="image" class="fileUpload form-control" />
												<i>(<?php echo JText::_('K2_MAX_UPLOAD_SIZE'); ?>: <?php echo ini_get('upload_max_filesize'); ?>)</i>
												<br />
												<br />
												<input type="text" name="existingImage" id="existingImageValue" class="text_area form-control" readonly />
												<br>
								...
								<div class="simpleTabsContent" id="k2Tab6">
									...
									<div id="addAttachment">
										<input type="button" class="btn btn-default btn-outline btn-sm" id="addAttachmentButton" value="<?php echo JText::_('K2_ADD_ATTACHMENT_FIELD'); ?>" />
										<i>(<?php echo JText::_('K2_MAX_UPLOAD_SIZE'); ?>: <?php echo ini_get('upload_max_filesize'); ?>)</i> </div>
							...
							<table class="sidebarDetails table">
								...
								<tr>
									...
									<td>
										...
										<input id="resetHitsButton" type="button" value="<?php echo JText::_('K2_RESET'); ?>" class="btn btn-xs btn-primary" name="resetHits" />
										<?php endif; ?>
									</td>
								</tr>
								<?php endif; ?>
								...
								<tr>
									...
									<td>
										...
										<?php endif; ?>
										<input id="resetRatingButton" type="button" value="<?php echo JText::_('K2_RESET'); ?>" class="btn btn-xs btn-primary" name="resetRating" />
									</td>
								</tr>
							</table>
							<?php endif; ?>
