...
<article>
	<div class="post-body">
		<div class="row">		
				...
				<div class="post-content mt-sm-20">
					...
					<!-- Item title -->
					<h2 class="post-title mt-0 mb-20">
					...
					<div class="post-meta clearfix">
						...
						<span class="catItemVote text-center">
							<span><i class="fa fa-heart"></i> <?php echo str_replace('(', '', str_replace(')', '', str_replace('votes', '', $this->item->numOfvotes))); ?> <?php echo JText::_('K2_VOTES'); ?></span>
						</span>
						<!-- End catItemVote -->
						<?php endif; ?>
