...
<div class="k2ReportCommentFormContainer">
	...
	<form action="<?php echo JURI::root(true); ?>/index.php" name="k2ReportCommentForm" id="k2ReportCommentForm" method="post">
		...
		<div class="form-group">
			...
			<textarea name="reportReason" id="reportReason" cols="60" rows="6" class="form-control"></textarea>
			<div class="bottom-border"></div>
		</div>
		...
		<?php endif; ?>
		<p>
			<button class="btn btn-primary"><?php echo JText::_('K2_SEND_REPORT'); ?></button>
