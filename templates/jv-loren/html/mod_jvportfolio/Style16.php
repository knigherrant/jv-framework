...
?>
<?php if($items):?>
<div id="pfo-mod-<?php echo $module->id;?>" class="portfolio-style16 portfolio<?php echo number_format(12/$column, 0)?> <?php echo implode(' ', array($params->get('moduleclass_sfx', '')))?>">
    <div class="row">
