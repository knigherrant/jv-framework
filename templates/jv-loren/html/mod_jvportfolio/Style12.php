...
?>
<?php if($items):?>
<div id="<?php echo "mod-frm-portfolio-{$module->id}"?>" class="portfolio-style12 portfolio<?php echo number_format(12/$column, 0)?> <?php echo implode(' ', array($params->get('moduleclass_sfx', '')))?>">
   ...
   <div class="clearfix topPortfolio">
            ...
            <div class="pfo-content">            
              <div class="pfo-content-table">
                <div class="pfo-content-table-cell">
                  ...
                  <span class="pfo-hasTag mb-20"><?php echo $item->tag?></span>
                  <?php endif;?>
                  <?php if($params->get('showLiked', 0)):?>
                   ...
                   <?php endif;?>
                  <a class="link-detail mt-10" href="<?php echo JRoute::_("index.php?option=com_jvportfolio&view=item&id={$item->id}")?>" title="<?php echo $item->name?>"><i class="fa fa-chevron-right"></i></a>               
                </div>
              </div>
            </div>
            <!-- end content -->
    ...
    <?php if($total):?>
    <?php require ModJvPortfolioHelper::loadTemplate('Style12_nav');?>
    <?php endif;?>
</div>
<?php endif;?>