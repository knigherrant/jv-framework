...
?>
<?php if($items):?>
<div id="<?php echo "mod-frm-portfolio-{$module->id}"?>" class="portfolio-style4 portfolio<?php echo number_format(12/$column, 0)?> <?php echo implode(' ', array($params->get('moduleclass_sfx', '')))?>">
          ...
          <div class="pfo-body">
            <div class="pfo-image">
              <div class="pfo-overlay">
                   <a class="link-detail" href="<?php echo JRoute::_("index.php?option=com_jvportfolio&view=item&id={$item->id}")?>" title="<?php echo $item->name?>"><i class="fa fa-plus"></i></a>               
              </div>
            ...
            <div class="pfo-content">            
              <div class="pfo-content-table">
                <div class="pfo-content-table-cell">
                  ...
                  <a  class="pfo-title mb-5" href="<?php echo JRoute::_("index.php?option=com_jvportfolio&view=item&id={$item->id}")?>"><?php echo $item->name?></a>
                  <?php endif;?>
                  <?php if($params->get('hasTag', 0)):?>
                  <span class="pfo-hasTag"><?php echo str_replace(',', ' /', $item->tag); ?></span>
                  <?php endif;?>
