...
?>
<?php if($items):?>
<div id="<?php echo "mod-frm-portfolio-{$module->id}"?>" class="portfolio-style2 portfolio<?php echo number_format(12/$column, 0)?> <?php echo implode(' ', array($params->get('moduleclass_sfx', '')))?>">
   ...
   <div class="clearfix topPortfolio">
    ...
    <?php if($total):?>
    <?php require ModJvPortfolioHelper::loadTemplate('Style2_nav'); ?>
    <?php endif;?>
</div>
<?php endif;?>