...
$numItemsdesktop = ($numItems > 1)?($numItems-1):$numItems;
...
?>
<?php if($items):?>
<div class="pfo-module portfolio-style7 portfolio<?php echo number_format(12/$column, 0)?> <?php echo implode(' ', array($params->get('moduleclass_sfx', '')))?>">
          ...
          <div class="pfo-body">
            <div class="pfo-image">
              <div class="pfo-overlay">
                <div class="pfo-overlay-inner">
                  ...
                  <?php endif;?>
                   <a class="link-detail" href="<?php echo JRoute::_("index.php?option=com_jvportfolio&view=item&id={$item->id}")?>"><i class="fa fa-link"></i></a>  
                </div>                             
              </div>
            ...
            <div class="pfo-content">
              ...
              <div class="pfo-tool">
                ...
                <div class="pfo-hasTag"><?php echo $item->tag?></div>
                <?php endif;?>                
                <?php if($params->get('hasDate', 0)):?>
                <div class="pfo-date"><?php echo date('F d, Y', strtotime($item->date_created))?></div>
                <?php endif;?>
              </div>              
            </div>
            <!-- end content -->
