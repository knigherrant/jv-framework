...
?>
<?php if($items):?>
<div id="<?php echo "mod-frm-portfolio-{$module->id}"?>" class="portfolio-style15 portfolio<?php echo number_format(12/$column, 0)?> <?php echo implode(' ', array($params->get('moduleclass_sfx', '')))?>">
   ...
   <div class="clearfix topPortfolio">
          ...
          <div class="pfo-body">
            <div class="pfo-image">
              <div class="pfo-overlay">
                   <a class="link-detail" href="<?php echo JRoute::_("index.php?option=com_jvportfolio&view=item&id={$item->id}")?>" title="<?php echo $item->name?>"><i class="fa fa-long-arrow-right"></i></a>               
              </div>
    ...
    <?php if($total):?>
    <?php require ModJvPortfolioHelper::loadTemplate('Style15_nav')?>
    <?php endif;?>
</div>
<?php endif;?>