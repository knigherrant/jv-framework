...
<div class="archive<?php echo $this->pageclass_sfx;?>">
	<form id="adminForm" action="<?php echo JRoute::_('index.php')?>" method="post" class="form-inline">
		...
		<div class="filter-search">
			...
			<button type="submit" class="btn btn-primary btn-sm btn-icon" style="vertical-align: top;"><i class="fa fa-filter"></i> <?php echo JText::_('JGLOBAL_FILTER_BUTTON'); ?></button>
