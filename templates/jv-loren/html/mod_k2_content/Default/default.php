...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
    ...
    <li <?php if(count($items)==$key+1) echo 'class="lastItem"'; ?>>
      ...
      <div class="moduleItemVideo" style="background-image: url(<?php echo $item->image; ?>);">
      	<?php echo $item->video ; ?>
      ...
      <?php endif; ?>
      <?php if(($params->get('itemCommentsCounter') && $componentParams->get('comments')) || ($params->get('itemAttachments') && count($item->attachments)) ||  $params->get('itemHits') || $params->get('itemReadMore')): ?>
