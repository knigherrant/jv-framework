...
<?php if ($show_product_list) :?> 
 <button id="dLabel" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-primary view_cart_link view_cart_link_1" data-text="<?php echo JText::_('TPL_MY_CART')?>">
    <i class="fa fa-shopping-cart"></i>
    <span class="cart-label"> <?php echo vmText::_('TPL_CART') ?>:</span>
    <span class="total_products"><?php echo  $data->totalProduct;?></span>
    <span class="cart-item" data-text="<?php echo vmText::_('TPL_ITEMS') ?>"><?php echo vmText::_('TPL_ITEMS') ?></span>
    <span class="cart-price hidden"><span><?php echo str_replace('<strong>', '</span><strong>', $data->billTotal); ?></span>
</button>
<div class="dropdown-menu" aria-labelledby="dLabel">
    <div class="moduleMiniCart">
        <h5 class="cart-header"><?php echo JText::_('TPL_SHOPPING_CART')?></h5>
        ...
        <div class="cart-footer">
            <div class="cart-subtotal"><span><?php echo str_replace('<strong>', '</span><strong>', $data->billTotal); ?></div>
