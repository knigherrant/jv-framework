...
else
{
	...
	if ($feed != false)
	{
		...
		?>
		<div style="direction: <?php echo $rssrtl ? 'rtl' :'ltr'; ?>; text-align: <?php echo $rssrtl ? 'right' :'left'; ?> ! important"  class="mod-feed<?php echo $moduleclass_sfx; ?>">
		<?php
		// Feed description
	...
	<?php if (!empty($feed))
	{ ?>
		<ul class="newsfeed<?php echo $params->get('moduleclass_sfx'); ?> list-unstyled">
			...
			?>
				<li class="panel panel-default">
					...
					<div class="panel-heading">
						<h5 class="feed-link panel-title">
					...
					<?php if ($params->get('rssitemdesc') && !empty($text)) : ?>
						<div class="feed-item-description panel-body">
						<?php
							// Strip the images.
