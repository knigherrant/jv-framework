...
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post">
	<div class="panel panel-default">
		<div class="form-group panel-heading">
			<div class="input-group pull-left">
				...
				<div class="input-group-btn">
					<button name="Search" onclick="this.form.submit()" class="btn btn-primary"><span class="fa fa-search"></span> <?php echo JHtml::tooltipText('COM_SEARCH_SEARCH');?></button>
				</div>
			</div>
		...
		<div class="panel-body">
			...
			<div class="row">
			<?php $col= ($this->params->get('search_areas', 1))?"6 mb-sm-60":"12"?>
...
<?php if ($this->total > 0) : ?>
	<div class="form-group panel panel-default">
		<div class="panel-body clearfix">			
			<div class="form-limit form-inline pull-left">
