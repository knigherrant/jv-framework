...
<div id="k2Container" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemAuthorBlock clearfix mb-50">
        ...
        <div class="itemAuthorDetails">
			...
			<span class="itemAuthorName mb-20 block text-uppercase h5"><?php echo $this->user->name; ?></span>
			<?php endif; ?>
			<?php if( ($this->params->get('userURL') && isset($this->user->profile->url) && $this->user->profile->url) || ($this->params->get('userEmail')) || ($this->params->get('userFeedIcon',1)) ): ?>
			<div class="itemAuthorLink">
				<?php if($this->params->get('userFeedIcon',1)): ?>
				<!-- RSS feed icon -->
					<a href="<?php echo $this->feed; ?>" title="<?php echo JText::_('K2_SUBSCRIBE_TO_THIS_RSS_FEED'); ?>"><?php echo JText::_('K2_SUBSCRIBE_TO_THIS_RSS_FEED'); ?></a>
				<?php endif; ?>
				<?php if ($this->params->get('userURL') && isset($this->user->profile->url) && $this->user->profile->url): ?>
				   <span><?php echo JText::_('K2_WEBSITE'); ?></span><a href="<?php echo $this->user->profile->url; ?>" target="_blank" rel="me" title="<?php echo JText::_('K2_WEBSITE'); ?>"><?php echo $this->user->profile->url; ?></a>
				<?php endif; ?>

				<?php if ($this->params->get('userEmail')): ?>
					<span><?php echo JText::_('K2_EMAIL'); ?></span><a rel="email" href="mailto:<?php echo $this->user->email; ?>" target="_blank" title="<?php echo JText::_('K2_EMAIL'); ?>"><?php echo $this->user->email; ?></a>
				<?php endif; ?>	
			</div>
			<?php endif; ?>
	...
	<div class="ItemList">
		...
		<div class="ItemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' ItemViewUnpublished'; ?><?php echo ($item->featured) ? ' ItemIsFeatured' : ''; ?> clearfix mb-50">
		  ...
		  <div class="ItemBody">
			  ...
			  <!-- Item title -->
			 <h4 class="ItemTitle post-title text-uppercase mt-0 mb-5">
              ...
              <div class="post-meta mb-20">
					...
					<span class="userItemCommentsLink">
						...
						<?php else: ?>
							...
							<a class="text-primary" href="<?php echo $item->link; ?>#itemCommentsAnchor">
