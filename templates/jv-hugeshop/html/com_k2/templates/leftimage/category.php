...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?> blog-wide blog-left">
	...
	<div class="pagination-wrap">
		<?php if($this->params->get('catPaginationResults')) echo '<div class="pagination-results pull-left">'.$this->pagination->getPagesCounter().'</div>'; ?>
