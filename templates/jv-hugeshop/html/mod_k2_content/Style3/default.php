...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock style-3<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?> blog-wide">
		    				...
		    				<div class="post-content">
		    					<div class="divtable">
		    						<div class="divtablecell">
										...
										<?php endif; ?>
										<?php if($params->get('itemAuthor') || $params->get('itemHits') || ($params->get('itemCommentsCounter') && $componentParams->get('comments')) ): ?>
											<div class="post-meta">							
												<?php if($params->get('itemAuthor') || $params->get('itemAuthorAvatar')): ?>
													<span>
														...
														<?php if(isset($item->authorLink)): ?>
															<span class="meta-label"><?php echo JText::_('TPL_BLOG_BY'); ?></span><a rel="author" title="<?php echo K2HelperUtilities::cleanHtml($item->author); ?>" href="<?php echo $item->authorLink; ?>" class="meta-value"><?php echo $item->author; ?></a>
														<?php else: ?>
															<span class="meta-label"><?php echo JText::_('TPL_BLOG_BY'); ?></span><span class="meta-value"> <?php echo $item->author; ?></span>
														<?php endif; ?>
													</span>
												<?php endif; ?>
										...
										<?php if($params->get('itemReadMore') && $item->fulltext): ?>
					    					<div class="post-readmore mt-30 text-center">
												<a class="btn btn-outline-thin btn-sm btn-dark text-primary" href="<?php echo $item->link; ?>">
