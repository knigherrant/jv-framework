...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock style-1<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?> blog-wide">
	    	...
	    	<div class="col-md-12">
			    <div class="post-body">
    				...
    				<?php if($params->get('itemReadMore') && $item->fulltext): ?>
    					<div class="post-readmore text-center mt-30">
