	...
	<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" name="login" id="form-login">
	  ...
	  <fieldset class="input">
	    ...
	    <p class="clearfix">
		    ...
		    <span id="form-login-remember" class="pull-right">
		      <label for="modlgn_remember"><input id="modlgn_remember" type="checkbox" name="remember" class="" value="yes" /> <?php echo JText::_('K2_REMEMBER_ME') ?></label>
		    </span>
		    <?php endif; ?>
		    <button type="submit" name="Submit" class="btn btn-primary btn-sm" ><?php echo JText::_('K2_LOGIN') ?></button>
		</p>
	  </fieldset>
