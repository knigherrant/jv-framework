		...
		?>
			<div class="checkout-button-top">
				<?php
					...
					echo '<a class="btn btn-dark btn-radius btn-outline pull-right" href="' .JRoute::_ ('index.php?option=com_virtuemart&view=category' . $categoryStr.$ItemidStr, FALSE) . '">' . vmText::_ ('COM_VIRTUEMART_CONTINUE_SHOPPING') . '</a>'; 
				?>
				<?php echo '<button type="submit"  id="checkoutFormSubmit" name="'.$this->checkout_task.'" value="1" class="btn btn-primary btn-radius" ><span>' . vmText::_('COM_VIRTUEMART_CHECKOUT_TITLE'). '</span> </button>'; ?>
			</div>
