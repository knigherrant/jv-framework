...
<div class="clearfix">
	<div class="row">
		<div class="col-sm-6">
			<div class="featured-box featured-box-secondary featured-box-cart ">
				<div class="box-content">
					<h4 class="text-size-20"><?php echo vmText::_ ('COM_VIRTUEMART_USER_FORM_BILLTO_LBL'); ?></h4>
					...
					?>
					<a class="<?php echo $this->pointAddress ?> text-headings" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=BT', $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
		...
		<div class="col-sm-6">
			<div class="featured-box featured-box-secondary featured-box-cart ">
				<div class="box-content">
					<h4 class="text-size-20"><?php echo vmText::_ ('COM_VIRTUEMART_USER_FORM_SHIPTO_LBL'); ?></h4>
					<?php // Output Bill To Address ?>
					<div class="output-shipto">
						...
						if($this->cart->user->virtuemart_user_id==0){
							...
							echo VmHtml::checkbox ('STsameAsBT', $this->cart->STsameAsBT,1,0,'id="STsameAsBTjs" data-dynamic-update=1') . '';
						} else if(!empty($this->cart->lists['shipTo'])){
							echo str_replace('</br>', '<br />', $this->cart->lists['shipTo'] );
						}
					...
					<a class="text-headings" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=ST&virtuemart_user_id[]=' . $this->cart->lists['current_id'], $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
