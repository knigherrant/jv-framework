...
?>
<div class="orderDetailOrder wraptable">
	<table class="table table-striped table-hover table-bordered" width="100%" cellspacing="0" cellpadding="0" border="0">
	    <tr>
	    ...
	    <tr>
			...
			<td class="orders-key" ><span class="product-price"><?php echo $this->currency->priceDisplay($this->orderdetails['details']['BT']->order_total, $this->currency); ?></span></td>
	    </tr>
	</table>
	<div class="row">
		<div class="col-sm-6">
			<div class="panel panel-default ">
				<div class="panel-body">
					<h3 class="panel-title cart customer-note"><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_BILL_TO_LBL') ?></h3>
					<hr>
		...
		<div class="col-sm-6">
			<div class="panel panel-default ">
				<div class="panel-body">
					<h3 class="panel-title cart customer-note"> <?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_SHIP_TO_LBL') ?></h3>
					<hr>
					<table width="100%" border="0"><?php
