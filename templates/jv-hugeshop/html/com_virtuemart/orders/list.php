...
if (count($this->orderlist) == 0) {
 ...
 ?>
<div id="editcell" class="wraptable listOrders">
	<table class="adminlist table table-striped table-hover table-bordered" width="100%">
		<thead>
		<tr>
			<th>
			...
			<?php
				...
				foreach ($this->orderlist as $row) {
					...
					<tr class="<?php echo "row$k"; ?>">
						...
						<td >
							<span class="product-price"><?php echo $this->currency->priceDisplay($row->order_total, $row->currency); ?></span>
						</td>
					</tr>
			<?php
					$k = 1 - $k;
