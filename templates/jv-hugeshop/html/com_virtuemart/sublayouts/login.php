...
defined('_JEXEC') or die('Restricted access');
  ...
  ?>
    <div class="row <?php echo ($this->order)?'loginOder':'';?>">
    <?php
        ...
        if ($this->order  ) { ?>
                ...
                <div class="box-content">
                  ...
                  <form action="<?php echo JRoute::_( 'index.php', 1, $this->useSSL); ?>" method="post" name="com-login" class="form-horizontal" >
                    ...
                    <div class="form-group" id="com-form-order-number">
                        <label for="order_number" class="col-sm-3 control-label"><?php echo vmText::_('COM_VIRTUEMART_ORDER_NUMBER') ?></label>
                        <div class="col-sm-9">
                          <input type="text" id="order_number" name="order_number" class="form-control" size="18"/>
                        </div>                        
                    </div>
                    <div class="form-group" id="com-form-order-pass">
                        <label for="order_pass" class="col-sm-3 control-label"><?php echo vmText::_('COM_VIRTUEMART_ORDER_PASS') ?></label>
                        <div class="col-sm-9">
                    ...
                    <div  id="com-form-order-submit" class="form-group">
                        <div class="col-sm-9 col-sm-offset-3">
                          <input type="submit" name="Submitbuton" class="btn btn-dark btn-outline btn-radius" value="<?php echo vmText::_('COM_VIRTUEMART_ORDER_BUTTON_VIEW') ?>" />
                        </div>
                    </div>
          ...
          <div class="col-sm-6">
            <div class="featured-box featured-box-secondary featured-box-cart ">
              <div class="box-content">
                <h4 <?php if ( !$this->order  ) echo 'class="text-center"'; ?> ><?php echo vmText::_('COM_VIRTUEMART_LOGIN') ?></h4>
                <form action="<?php echo JRoute::_('index.php', $this->useXHTML, $this->useSSL); ?>" method="post" name="com-login" class="form-horizontal">
                  ...
                  <div class="userdata">
                    <div class="form-group" id="com-form-login-username">
                      <label for="vmusername" class="col-sm-3 col-md-2 control-label"><?php echo vmText::_('COM_VIRTUEMART_USERNAME'); ?></label>
                    ...
                    <div class="form-group" id="com-form-login-password">
                      <label for="modlgn-passwd" class="col-sm-3 col-md-2 control-label"><?php echo vmText::_('COM_VIRTUEMART_PASSWORD'); ?></label>
                      <div class="col-sm-9 col-md-10">
                    ...
                    <div class="form-group" id="form-login-submit">
                      ...
                      <?php endif; ?>
                        <input type="submit" name="Submit" class="btn btn-dark btn-outline btn-radius" value="<?php echo vmText::_('COM_VIRTUEMART_LOGIN') ?>" />
                      </div>
                    </div>
                  </div>
                  <div class="form-group" >
                    <ul class="list-unstyled col-sm-9 col-md-10 col-sm-offset-3 col-md-offset-2">
            ...
            <div class="featured-box featured-box-secondary featured-box-cart ">
              <div class="box-content">
                ...
                <form action="<?php echo JRoute::_('index.php', $this->useXHTML, $this->useSSL); ?>" method="post" name="com-login" class="form-horizontal">
                  ...
                  <div class="form-group">
                    <div class="col-sm-12">
                    <a title=" <?php echo vmText::_('COM_VIRTUEMART_ORDER_FORGOT_YOUR_USERNAME'); ?>" href="<?php echo JRoute::_('index.php?option=com_users&view=remind'); ?>"><?php echo vmText::_('COM_VIRTUEMART_ORDER_FORGOT_YOUR_USERNAME'); ?></a> | 
                    <a title=" <?php echo vmText::_('COM_VIRTUEMART_ORDER_FORGOT_YOUR_PASSWORD'); ?>" href="<?php echo JRoute::_('index.php?option=com_users&view=reset'); ?>"><?php echo vmText::_('COM_VIRTUEMART_ORDER_FORGOT_YOUR_PASSWORD'); ?></a>
                    </div>
                  </div>
                  <input type="hidden" name="task" value="user.login" />
                  <input type="hidden" name="option" value="com_users" />
...
<?php  
    ...
    <form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="login" id="form-login" class="text-center">
      <div class="heading-style1 text-center mb-60">
        <h4 class="text-uppercase"><?php echo vmText::sprintf('COM_VIRTUEMART_WELCOME_USER', $user->name); ?></h4>
        <div class="heading-sub">
          <input type="submit" name="Submit" class="btn btn-sm btn-dark btn-outline btn-radius" value="<?php echo vmText::_( 'COM_VIRTUEMART_BUTTON_LOGOUT'); ?>">
        </div>
      </div>      
      <input type="hidden" name="option" value="com_users" />
