...
<div class="tabs tabs-2 tabs-2x">
	...
	foreach ($viewData['products'] as $type => $products ) {
		...
		$cols_sm = 4; floor ( 12 / $per_row_sm );
		$per_row_xs = ($per_row_sm > 1)?($per_row_sm - 1):$per_row_sm;
		$cols_xs = 6; floor ( 12 / $per_row_xs );
			...
			<div class="vmProduct<?php echo ' col-xxs-12 col-xs-'. $cols_xs.' col-sm-'.$cols_sm.' col-md-' . $cols;?>"> 
				<div class="thumb-item">
					...
					<div class="thumb-item-content">
						<h5 class="thumb-title" title="<?php echo $product->product_name; ?>"><?php echo JHtml::link ($product->link.$ItemidStr, $product->product_name); ?></h5>
