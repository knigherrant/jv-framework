...
<form method="post" action="<?php echo JRoute::_('index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id='.$this->product->virtuemart_product_id.'&virtuemart_category_id='.$this->product->virtuemart_category_id, FALSE) ; ?>" name="notifyform" id="notifyform">
	...
	<div class="input-group">
      <input class="form-control" type="text" name="notify_email" value="<?php echo $this->user->email; ?>" />
      <span class="input-group-btn">
        <input type="submit" name="notifycustomer"  class="btn btn-primary" value="<?php echo vmText::_('COM_VIRTUEMART_CART_NOTIFY') ?>" title="<?php echo vmText::_('COM_VIRTUEMART_CART_NOTIFY') ?>" />
      </span>
    </div><!-- /input-group -->
