...
?>
<div class="VmGroup <?php echo $params->get ('moduleclass_sfx') ?> products-<?php echo $products_per_row; ?> style4">
	...
	if ($display_style == "div") { //Slide
		...
		<div class="row">
			<div class="multi-slides multi-slides-right carouselOwl" 
				...
				data-itemsdesktop="<?php echo ($products_per_row > 2)?($products_per_row - 1):$products_per_row ?>" 
				data-itemsdesktopsmall="<?php echo ($products_per_row > 3)?($products_per_row - 2):$products_per_row ?>" 
				data-itemstablet="3" 
		...
		$cols = floor ( 12 / $products_per_row );
		$per_row_md = ($products_per_row > 1)?($products_per_row - 1):$products_per_row;
		$cols_md = ($products_per_row == 6)?'3':floor ( 12 / $per_row_md );
		$cols_sm = 4;
		...
		<div class="row">
			<?php foreach ($products as $product) : ?>
			<?php $url = JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=' . $product->virtuemart_product_id . '&virtuemart_category_id=' .	$product->virtuemart_category_id); ?>
			<div class="vmProduct<?php echo ' col-xxs-12 col-xs-'. $cols_xs.' col-sm-'.$cols_sm.' col-md-' . $cols_md .' col-lg-' . $cols;?>"> 
				<div class="thumb-item">
					<div class="thumb-item-img">
						<a title="<?php echo $product->product_name ?>" href="<?php echo $url; ?>" class="img-slide">
						<?php echo shopFunctionsF::renderVmSubLayout('list_image',array('product'=>$product)); ?>
