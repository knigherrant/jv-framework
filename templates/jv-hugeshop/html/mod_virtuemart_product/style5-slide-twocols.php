...
?>
<div class="VmGroup <?php echo $params->get ('moduleclass_sfx') ?> products-<?php echo $products_per_row; ?> style5 twocols">
								...
								<div class="thumb-item-img">
									<?php 
										...
										if ($product->images[0]->file_name) {
											$background = $product->images[0]->file_url;
										} else {
											$background = 'components/com_virtuemart/assets/images/vmgeneral/noimage.gif';
										}
									?>
									<a title="<?php echo $product->product_name ?>" href="<?php echo $url; ?>" class="img-slide" style="background-image: url(<?php echo $background; ?>);">
									<?php echo shopFunctionsF::renderVmSubLayout('list_image hidden',array('product'=>$product)); ?>
									</a>
