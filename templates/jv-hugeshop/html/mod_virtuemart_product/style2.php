...
?>
<div class="VmGroup <?php echo $params->get ('moduleclass_sfx') ?> products-<?php echo $products_per_row; ?> style2">
	...
	<?php endif; ?>
	<?php if ($params->get('filter_category')) { ?>
		<?php $caturl = JRoute::_ ( 'index.php?option=com_virtuemart&view=category&virtuemart_category_id=' . $params->get('virtuemart_category_id') , FALSE); ?>
		<div class="text-center pt-40"><a href="<?php echo $caturl ?>" title="<?php echo JText::_('TPL_READ_MORE') ?>" class="btn btn-rounder btn-outline-thin btn-dark"><i class="huge-refresh"></i> <?php echo JText::_('TPL_READ_MORE') ?></a></div>
	<?php } ?>
</div>