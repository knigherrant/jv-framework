...
<button class="btn btn-login" data-toggle="modal" data-target="#login-modal-<?php echo $module->id; ?>"><i class="huge-lock"></i><span> <?php echo JText::_('JLOGIN') ?></span></button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <h4 class="text-uppercase"><?php echo JText::_('JLOGIN') ?></h4>  
        <form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" class="form">
          ...
          <div class="userdata">
            ...
            <div id="form-login-submit" class="form-group clearfix mt-20">
              ...
              <?php endif; ?>
              <button type="submit" tabindex="0" name="Submit" class="btn btn-dark btn-outline btn-radius"><i class="gs-locker-streamline-unlock"></i> <?php echo JText::_('JLOGIN') ?></button>
            </div>
            <?php
               ?>
