...
<?php if ($params->get('pretext')) : ?>
          ...
          <div class="userdata">
            ...
            <div id="form-login-submit" class="form-group clearfix">
	            ...
	            <div id="form-login-remember" class="pull-left pt-5">
	            ...
	            <?php endif; ?>
	            <button type="submit" tabindex="0" name="Submit" class="btn btn-dark btn-radius btn-outline pull-right"><?php echo JText::_('JLOGIN') ?></button>
            </div>
		<?php
