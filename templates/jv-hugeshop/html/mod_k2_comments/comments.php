...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2LatestCommentsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
	...
	<ul>
		...
		<li class="clearfix">
			...
			<div class="info">
				...
				<a href="<?php echo $comment->link; ?>"><span class="lcComment"><span class="fa fa-quote-left"></span> <?php echo $comment->commentText; ?></span></a>
				<?php else: ?>
				<span class="lcComment"><span class="fa fa-quote-left"></span> <?php echo $comment->commentText; ?></span>
				<?php endif; ?>
	...
	<div class="k2FeedIcon">
		<a href="<?php echo JRoute::_('index.php?option=com_k2&view=itemlist&format=feed&moduleID='.$module->id); ?>" title="<?php echo JText::_('K2_SUBSCRIBE_TO_THIS_RSS_FEED'); ?>">
			<span><span class="icon-rss"></span> <?php echo JText::_('K2_SUBSCRIBE_TO_THIS_RSS_FEED'); ?></span>
		</a>
		<div class="clr"></div>
	</div>
	<?php endif; ?>
