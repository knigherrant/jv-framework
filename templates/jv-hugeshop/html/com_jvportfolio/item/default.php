<?php
  ...
  $show_details = 1;
?>
<?php if (!$show_title && !$show_desc && !$show_date && !$show_cat && !$show_client && !$show_tag && !$show_link && !$show_vote && empty($this->params->get( 'btnsocial', '' ))) $show_details = 0;?>
<?php if ($this->item) : ?>
<div class="portfolio-detail-default clearfix">
  <div class="row">
    <?php if ($this->item->pfo_v) { ?>
      <div class="<?php echo ($show_details)?'col-sm-12 col-md-8':'col-sm-12 col-md-12';?>">
    ...
    <?php } else { ?>
      <?php if ($this->item->gallery) { ?>
        <div class="<?php echo ($show_details)?'col-sm-12 col-md-8':'col-sm-12 col-md-12';?>">
            <div class="carouselOwl pfo-detail-gallery mb-30" 
        ...
        <?php } ?>
    <?php } ?>
    <div class="<?php echo ($this->item->gallery || $this->item->pfo_v)?'col-sm-12 col-md-4':'col-sm-12 col-md-12';?>">
      <div class="pfo-detail-body">
        ...
        <div class="pfo-detail-desc pt-20 mb-30"><?php echo $this->item->desc?></div>
        <?php endif; ?>
        <div class="row">
