...
<button class="btn btn-search-modal" data-toggle="modal" data-target="#search-modal-<?php echo $module->id; ?>" data-text="<?php echo $button_text;?>"><i class="huge-search"></i></button>
