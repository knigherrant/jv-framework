...
// Favicon
$this['template']->document->addFavicon($this['path']->url('theme::icon/favicon.ico?v=2'));
$this['template']->document->addHeadLink($this['path']->url('theme::icon/favicon-16x16.png?v=2'), 'icon', 'rel', array('sizes' => '16x16', 'type' => 'image/png'));
$this['template']->document->addHeadLink($this['path']->url('theme::icon/favicon-32x32.png?v=2'), 'icon', 'rel', array('sizes' => '32x32', 'type' => 'image/png'));
$this['template']->document->addHeadLink($this['path']->url('theme::icon/favicon-96x96.png?v=2'), 'icon', 'rel', array('sizes' => '96x96', 'type' => 'image/png'));
...
// Apple Icon
$this['template']->document->addHeadLink($this['path']->url('theme::icon/apple-icon-57x57.png'), 'apple-touch-icon');
$this['template']->document->addHeadLink($this['path']->url('theme::icon/apple-icon-60x60.png'), 'apple-touch-icon', 'rel', array('sizes' => '60x60'));
$this['template']->document->addHeadLink($this['path']->url('theme::icon/apple-icon-72x72.png'), 'apple-touch-icon', 'rel', array('sizes' => '72x72'));
$this['template']->document->addHeadLink($this['path']->url('theme::icon/apple-icon-76x76.png'), 'apple-touch-icon', 'rel', array('sizes' => '76x76'));
$this['template']->document->addHeadLink($this['path']->url('theme::icon/apple-icon-114x114.png'), 'apple-touch-icon', 'rel', array('sizes' => '114x114'));
$this['template']->document->addHeadLink($this['path']->url('theme::icon/apple-icon-120x120.png'), 'apple-touch-icon', 'rel', array('sizes' => '120x120'));
$this['template']->document->addHeadLink($this['path']->url('theme::icon/apple-icon-152x152.png'), 'apple-touch-icon', 'rel', array('sizes' => '152x152'));
$this['template']->document->addHeadLink($this['path']->url('theme::icon/apple-icon-152x152.png'), 'apple-touch-icon', 'rel', array('sizes' => '152x152'));
$this['template']->document->addHeadLink($this['path']->url('theme::icon/apple-icon-180x180.png'), 'apple-touch-icon', 'rel', array('sizes' => '180x180'));
