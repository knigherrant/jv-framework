 ...
 * item Table class
 */
class JvportfolioTableitem extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__jvportfolio_item', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '') {
        ...
        // field categories
        $this->buildType($array, 'cate');
        
        // field tags
        $this->buildType($array);
        ...
        if (!JFactory::getUser()->authorise('core.admin', 'com_jvportfolio.item.' . $array['id'])) {
            $actions = JFactory::getACL()->getActions('com_jvportfolio', 'item');
            $default_actions = JFactory::getACL()->getAssetRules('com_jvportfolio.item.' . $array['id'])->getData();
            $array_jaccess = array();
    ...
    /* Build type, include(tag, category) */
    private function buildType(&$array, $field='tag'){
        if ( isset($array[$field]) && !empty($array[$field]) ) {
            ...
            if ( is_array($array[$field])) {
                ...
                foreach ($array[$field] as $singleTag) {
    ...
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_jvportfolio.item.' . (int) $this->$k;
    }
    ...
    protected function _getAssetParentId(JTable $table = null, $id = null) {
        ...
        $assetParent->loadByName('com_jvportfolio');
