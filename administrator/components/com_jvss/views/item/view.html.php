...
class JvssViewItem extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        $canDo = JvssHelper::getActions();

        JToolBarHelper::title(JText::_('COM_JVSS_TITLE_ITEM'), 'image');
        ...
        JToolBarHelper::custom( 'item.inline-config', 'cog', 'cog', 'COM_JVSS_TITLE_ITEM_INLINE_CONFIG', false );
        JToolBarHelper::custom( 'item.inline-scss', 'smiley', 'smiley', 'COM_JVSS_TITLE_ITEM_INLINE_CSS', false );
