tinymce.PluginManager.add("image", function(e) {
    function openmanager() {
        ...
        win = e.windowManager.open({
            ...
            data: data,
            classes: 'filemanager',
            file: tinyMCE.baseURL + '/plugins/filemanager/dialog.php?type=1&editor=' + e.id + '&lang=' + tinymce.settings.language + '&subfolder=' + tinymce.settings.subfolder + '&base_url=' + JV.base_url,
            filetype: 'image',
            width: 900,
            height: 600,
            inline: 1
