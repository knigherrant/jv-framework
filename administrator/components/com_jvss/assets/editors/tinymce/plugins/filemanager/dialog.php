...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <?php $req_base_url = isset( $_REQUEST[ 'base_url' ] ) ? $_REQUEST[ 'base_url' ] : $base_url; ?>
		...
		<input type="hidden" id="base_url" value="<?php echo( $req_base_url ); ?>"/>
		...
		foreach ($files as $file) {
			...
			<li>
				<figure>
				    ...
				    href="dialog.php?type=<?php echo $_GET['type']?>&subfolder=<?php echo $subfolder ?>&editor=<?php echo $_GET['editor'] ? $_GET['editor'] : 'mce_0'; ?>&popup=<?php echo $popup;?>&field_id=<?php echo $_GET['field_id'] ? $_GET['field_id'] : '';?>&lang=<?php echo $_GET['lang'] ? $_GET['lang'] : 'en_EN'; ?>&fldr=<?php echo $src ?>&<?php echo uniqid() ?>&base_url=<?php echo $req_base_url; ?>">
			<?php if($file==".."){ ?>
